...
namespace OpenWifi::SecurityObjects {
	...
	*/
	PermissionMap GetAllPermissions(bool allowed) {
		...
		permissions[PM_VENUES_PROV][PT_CREATE] = allowed;
		permissions[PM_VENUES_PROV][PT_DELETE] = allowed;
		permissions[PM_VENUES_PROV][PT_UPDATE] = allowed;
		permissions[PM_VENUES_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_VENUES_LIST_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_ENTITIES_PROV][PT_CREATE] = allowed;
		permissions[PM_ENTITIES_PROV][PT_DELETE] = allowed;
		permissions[PM_ENTITIES_PROV][PT_UPDATE] = allowed;
		permissions[PM_ENTITIES_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_ENTITIES_LIST_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_INVENTORY_PROV][PT_CREATE] = allowed;
		permissions[PM_INVENTORY_PROV][PT_DELETE] = allowed;
		permissions[PM_INVENTORY_PROV][PT_UPDATE] = allowed;
		permissions[PM_INVENTORY_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_INVENTORY_LIST_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_MANAGEMENTPOLICY_PROV][PT_CREATE] = allowed;
		permissions[PM_MANAGEMENTPOLICY_PROV][PT_DELETE] = allowed;
		permissions[PM_MANAGEMENTPOLICY_PROV][PT_UPDATE] = allowed;
		permissions[PM_MANAGEMENTPOLICY_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_MANAGEMENTPOLICY_LIST_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_MANAGEMENTROLE_PROV][PT_CREATE] = allowed;
		permissions[PM_MANAGEMENTROLE_PROV][PT_DELETE] = allowed;
		permissions[PM_MANAGEMENTROLE_PROV][PT_UPDATE] = allowed;
		permissions[PM_MANAGEMENTROLE_PROV][PT_READ_ONLY] = allowed;

		permissions[PM_MANAGEMENTROLE_LIST_PROV][PT_READ_ONLY] = allowed;	

		//GATEWAY
		permissions[PM_SCRIPTS_GW][PT_CREATE] = allowed;
		permissions[PM_SCRIPTS_GW][PT_DELETE] = allowed;
		permissions[PM_SCRIPTS_GW][PT_UPDATE] = allowed;

		permissions[PM_DEVICE_CONFIGURE_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_UPGRADE_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_REBOOT_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_FACTORY_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_LEDS_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_TRACE_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_WIFISCAN_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_EVENTQUEUE_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_TELEMETRY_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_PING_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_SCRIPT_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_RRM_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_TRANSFER_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_CERTUPDATE_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_POWERCYCLE_GW][PT_CREATE] = allowed;		

		permissions[PM_DEVICE_LOGS_GW][PT_READ_ONLY] = allowed;		
		permissions[PM_DEVICE_LOGS_GW][PT_DELETE] = allowed;	
		permissions[PM_DEVICE_HEALTHCHECKS_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_HEALTHCHECKS_GW][PT_DELETE] = allowed;
		permissions[PM_DEVICE_CAPABILITIES_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_CAPABILITIES_GW][PT_DELETE] = allowed;
		permissions[PM_DEVICE_STATISTICS_GW][PT_CREATE] = allowed;
		permissions[PM_DEVICE_STATISTICS_GW][PT_DELETE] = allowed;

		permissions[PM_DEVICE_STATUS_GW][PT_READ_ONLY] = allowed;
		permissions[PM_DEVICE_RTTY_GW][PT_READ_ONLY] = allowed; // /api/v1/device/{serialNumber}/rtty
